...
urlpatterns = [
    ...
    path(
        "expedientes/<int:expediente_id>/asignar-responsable/",
        AsignarResponsableView.as_view(),
        name="asignar_responsable",
    ),
    path(
        "expedientes/<int:expediente_id>/concluir/",
        ConcluirExpedienteView.as_view(),
        name="concluir_expediente",
    ),
    path(
        "expedientes/<int:expediente_id>/cambiar-estado/",
        CambiarEstadoExpedienteView.as_view(),
    ...
    path(
        "expedientes/<int:expediente_id>/documentos/",
        DocumentosPorExpedienteView.as_view(),
        name="documentos_por_expediente",
    ),

    path(
        "expedientes/<int:expediente_id>/movimientos/",
        MovimientosPorExpedienteView.as_view(),
        name="movimientos_por_expediente",
    ),
    ...
    path(
        ...
        name="lista_password_reset_requests",
    ),
