...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("MYSQL_PASSWORD", "mishellCast55"),
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'juanmanue.gv@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'khfzokifijgxymgh')
